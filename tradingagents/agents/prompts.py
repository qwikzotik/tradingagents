"""Externalized system prompts for all agent modules.

This module centralizes prompt strings so they can be reviewed, tested,
and modified in one place rather than being scattered across agent files.

Prompts that use f-string interpolation in the original code are converted
to str.format()-compatible templates with named placeholders.
"""

# ---------------------------------------------------------------------------
# Shared analyst collaboration template (used by all 4 analyst nodes)
# ---------------------------------------------------------------------------
...
# Per-analyst context suffixes (the trailing sentence that varies)
MARKET_ANALYST_CONTEXT = "The company we want to look at is {ticker}"
FUNDAMENTALS_ANALYST_CONTEXT = "The company we want to look at is {ticker}"
NEWS_ANALYST_CONTEXT = "We are looking at the company {ticker}"
SOCIAL_MEDIA_ANALYST_CONTEXT = "The current company we want to analyze is {ticker}"

# ---------------------------------------------------------------------------
# Analyst role-specific system messages
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Researcher prompts (bull / bear debate)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Manager prompts (research manager / risk manager)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Risk debate prompts (aggressive / conservative / neutral)
# ---------------------------------------------------------------------------
...
TRADER_USER_PROMPT = "Based on a comprehensive analysis by a team of analysts, here is an investment plan tailored for {company_name}. This plan incorporates insights from current technical market trends, macroeconomic indicators, and social media sentiment. Use this plan as a foundation for evaluating your next trading decision.\n\nProposed Investment Plan: {investment_plan}\n\nLeverage these insights to make an informed and strategic decision."
